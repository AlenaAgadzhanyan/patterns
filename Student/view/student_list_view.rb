...
require_relative "../model/strategy/student_list_base.rb"
require_relative "../model/strategy/storage_strategy_json.rb"
require_relative "../model/strategy/storage_strategy_yaml.rb"
include Fox
